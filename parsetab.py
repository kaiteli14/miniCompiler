...
_lr_productions = [
  ...
  ('statement -> block_statement','statement',1,'p_statement_block_statement','miniFrontEnd.py',153),
  ('statement_decl_list -> statement_decl_list SEMICOLON statement_decl','statement_decl_list',3,'p_statement_decl_list_A','miniFrontEnd.py',157),
  ('statement_decl_list -> statement_decl','statement_decl_list',1,'p_statement_decl_list_B','miniFrontEnd.py',162),
  ('statement_decl_list -> epsilon','statement_decl_list',1,'p_statement_decl_list_C','miniFrontEnd.py',166),
  ('statement_decl -> statement','statement_decl',1,'p_statement_decl','miniFrontEnd.py',171),
  ('statement_decl -> decl','statement_decl',1,'p_statement_decl','miniFrontEnd.py',172),
  ('decl -> ID COLON type Initiation','decl',4,'p_decl','miniFrontEnd.py',177),
  ('Initiation -> EQUALS expression','Initiation',2,'p_with_initiation','miniFrontEnd.py',184),
  ('Initiation -> epsilon','Initiation',1,'p_no_initiation','miniFrontEnd.py',188),
  ('identifier -> ID','identifier',1,'p_identifier','miniFrontEnd.py',194),
  ('type -> INT','type',1,'p_type','miniFrontEnd.py',198),
  ('expression -> PLUS expression','expression',2,'p_expression_uniop','miniFrontEnd.py',207),
  ('expression -> MINUS expression','expression',2,'p_expression_uniop','miniFrontEnd.py',208),
  ('expression -> NOT expression','expression',2,'p_expression_uniop','miniFrontEnd.py',209),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','miniFrontEnd.py',215),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','miniFrontEnd.py',216),
  ('expression -> expression EXPONENT expression','expression',3,'p_expression_binop','miniFrontEnd.py',217),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','miniFrontEnd.py',218),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','miniFrontEnd.py',219),
  ('expression -> expression MODULUS expression','expression',3,'p_expression_binop','miniFrontEnd.py',220),
  ('expression -> expression LESS expression','expression',3,'p_expression_binop','miniFrontEnd.py',221),
  ('expression -> expression LESS_EQ expression','expression',3,'p_expression_binop','miniFrontEnd.py',222),
  ('expression -> expression GREATER expression','expression',3,'p_expression_binop','miniFrontEnd.py',223),
  ('expression -> expression GREATER_EQ expression','expression',3,'p_expression_binop','miniFrontEnd.py',224),
  ('expression -> expression IS_EQ expression','expression',3,'p_expression_binop','miniFrontEnd.py',225),
  ('expression -> expression NOT_EQ expression','expression',3,'p_expression_binop','miniFrontEnd.py',226),
  ('expression -> expression AND expression','expression',3,'p_expression_binop','miniFrontEnd.py',227),
  ('expression -> expression OR expression','expression',3,'p_expression_binop','miniFrontEnd.py',228),
  ('expression -> identifier EQUALS expression','expression',3,'p_expression_binop','miniFrontEnd.py',229),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','miniFrontEnd.py',235),
  ('expression -> INT_LITERAL','expression',1,'p_expression_int_literal','miniFrontEnd.py',241),
  ('expression -> identifier','expression',1,'p_expression_id','miniFrontEnd.py',247),
  ('epsilon -> <empty>','epsilon',0,'p_epsilon','miniFrontEnd.py',256),
]
